...
int main(int argc, char* args[])
{
	...
	if(InitSDL())
	{
		...
		//Start the music.
		//LoadMusic("Music/Thunder Dreams.mp3");
...
{	
	...
	else
	{
		...
		gWindow = SDL_CreateWindow("SuperCoolSolarSystem760", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN);
